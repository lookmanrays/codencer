...
type AdminStore interface {
	...
	ListConnectorEventsScoped(ctx context.Context, orgID, workspaceID, projectID, installationID string, limit int) ([]ConnectorEvent, error)
	...
	ListCloudAuditEventsScoped(ctx context.Context, orgID, workspaceID, projectID string, limit int) ([]CloudAuditEvent, error)
