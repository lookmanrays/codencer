...
type Adapter interface {
	...
	Start(ctx context.Context, step *Step, attempt *Attempt, workspaceRoot, attemptArtifactRoot string) error
	...
	CollectArtifacts(ctx context.Context, attemptID string, attemptArtifactRoot string) ([]*Artifact, error)
