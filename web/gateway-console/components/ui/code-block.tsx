...
export function CodeBlock({
  ...
  return (
    <div
      className={cn(
        "overflow-hidden rounded-[var(--radius-card)] border border-border bg-code-bg text-code-fg",
        className,
      )}
    >
...
export function CommandBlock({
  ...
  return (
    <div>
      {title ? (
        <p className="mb-xs mt-0 font-mono text-mono tracking-[0.04em] text-ink-muted">
          {title}
        </p>
      ) : null}
