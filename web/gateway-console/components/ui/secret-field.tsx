...
export function SecretField({ label, value = "redacted" }: { label: string; value?: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-sm rounded-[var(--radius-card)] border border-border bg-paper-strong p-sm">
      <div>
        <p className="m-0 font-mono text-mono uppercase tracking-[0.12em] text-ink-muted">{label}</p>
